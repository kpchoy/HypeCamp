...
u3 = User.create!(email: 'Pam@gmail.com', first_name: "Pam",
  last_name: "Beesly", password: "123456")
...
u6 = User.create!(email: 'Ryan@gmail.com', first_name: "Ryan",
  last_name: "Howard", password: "123456")
u7 = User.create!(email: 'Erin@gmail.com', first_name: "Erin",
  last_name: "Hannon", password: "123456")
u8 = User.create!(email: 'Toby@gmail.com', first_name: "Toby",
  last_name: "Flenderson", password: "123456")
u9 = User.create!(email: 'Angela@gmail.com', first_name: "Angela",
  last_name: "Martin", password: "123456")
...
c2 = Campsite.create!(owner_id: u2.id, title: "Wild Tender Tipi Ocean View", 
...
c5 = Campsite.create!(owner_id: u5.id, title: "Free Grazing Land", 
...
c6 = Campsite.create!(owner_id: u6.id, title: "FollyFootFrolic", 
...
c7 = Campsite.create!(owner_id: u7.id, title: "Bumps & Bruzas Riverfront", 
...
c8 = Campsite.create!(owner_id: u8.id, title: "Running Deer TIPI near Bryce Canyon", 
...
c9 = Campsite.create!(owner_id: u9.id, title: "Winter wonderland near skiing", 
...
b2u2 = Booking.create!(campsite_id: c6.id, guest_id: u2.id, guests: 5, 
...
r1c4u5 = Review.create!(body: "My cats had such a fun time at this location",
author_id: u9.id, campsite_id: c4.id, rating: 5)